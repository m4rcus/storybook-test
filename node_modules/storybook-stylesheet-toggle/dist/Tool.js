 ...
 * @returns
 */
var generateLinkList = function generateLinkList(list, set, current, close) {
...
var Tool = function Tool() {
  ...
  var updateSelectedStylesheet = (0, _react.useCallback)(function (id) {
  ...
  return stylesheets.length ? /*#__PURE__*/_react["default"].createElement(_components.WithTooltip, {
    placement: "top",
    trigger: "click",
    tooltip: function tooltip(_ref) {
      ...
      return /*#__PURE__*/_react["default"].createElement(_components.TooltipLinkList, {
        links: generateLinkList(stylesheets, updateSelectedStylesheet, selectedStylesheetID, onHide)
      });
    },
    closeOnClick: true
